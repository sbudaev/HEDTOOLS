...
Latest PDF version: +
http://158.37.63.57/doc/HEDTOOLS.pdf
...
AHA Repository:
https://subversion.uib.no/repos/aha-fortran/[https://subversion.uib.no/repos/aha-fortran/]

indexterm:[AHA repository]

AHA Tools stable version (trunk):
https://subversion.uib.no/repos/aha-fortran/trunk/HEDTOOLS/[https://subversion.uib.no/repos/aha-fortran/trunk/HEDTOOLS/]
...
IMPORTANT: AHA Tools in _trunk_ (stable version) can be found here:
           +https://subversion.uib.no/repos/aha-fortran/trunk/HEDTOOLS/+;
           Development versions are here:
           +https://subversion.uib.no/repos/aha-fortran/branches/budaev/HEDTOOLS/+.
           So standard checkout (the _stable_ version) is like this: +
           +svn checkout https://subversion.uib.no/repos/aha-fortran/trunk/HEDTOOLS/+
indexterm:[AHA repository]
...
[source,bash]
--------------------------------------------------------------------------------
svn --username u01 checkout https://subversion.uib.no/repos/aha-fortran/branches/budaev/HED18
--------------------------------------------------------------------------------
...
[source,bash]
--------------------------------------------------------------------------------
svn checkout https://subversion.uib.no/repos/aha-fortran/branches/budaev/HED18
--------------------------------------------------------------------------------
...
svn checkout https://subversion.uib.no/repos/aha-fortran/branches/budaev/HED18
...
svn checkout https://subversion.uib.no/repos/aha-fortran/branches/budaev/HEDTOOLS
--------------------------------------------------------------------------------
...
svn mkdir https://subversion.uib.no/repos/aha-fortran/old_archived
--------------------------------------------------------------------------------
...
svn mv https://subversion.uib.no/repos/aha-fortran/trunk/model_20151013 \
      https://subversion.uib.no/repos/aha-fortran/old_archived/model_20151013
....
# Copy a file to another branch -- use cp (copy) command
svn cp https://subversion.uib.no/repos/aha-fortran/trunk/hormones/Hormones.f90 \
  https://subversion.uib.no/repos/aha-fortran/branches/camilla/hormones/Hormones.f90
--------------------------------------------------------------------------------
...
[source,bash]
--------------------------------------------------------------------------------
svn copy https://subversion.uib.no/repos/aha-fortran/branches/budaev/HED18 \
    https://subversion.uib.no/repos/aha-fortran/branches/natasha/HED18 \
...
[source, bash]
--------------------------------------------------------------------------------
 svn relocate --username user_name https://subversion.uib.no/repos/aha-fortran/
--------------------------------------------------------------------------------
...
+davs://subversion.uib.no/repos/aha-fortran/+
...
An **extension** object can be declared, that will use all the properties and
type-bound procedures of the base object and add its own additional ones. This
allows creating complex inheritance hierarchies across objects.
...
related objects within the same <<MODULES_INTRO, Fortran module>>.
...
** Module http://158.37.63.57/doxydoc/classcommondata.html[COMMONDATA] Setting
   common parameters for the model.

** Module http://158.37.63.57/doxydoc/classthe__genome.html[THE_GENOME]
   Implementation of the genome objects, gene, alleles, chromosomes.

** Module http://158.37.63.57/doxydoc/classthe__hormones.html[THE_HORMONES]
   Architecture of the hormones and their functions.

** Module http://158.37.63.57/doxydoc/classthe__neurobio.html[THE_NEUROBIO]
   Implements neurobiological architectures based on sigmoid function,
   decision making and GOS.

** Module http://158.37.63.57/doxydoc/classthe__individual.html[THE_INDIVIDUAL]
   Implements the individual agent in the final form and the individual-based
   model functions.

** Module http://158.37.63.57/doxydoc/classthe__population.html[THE_POPULATION]
   Implements the population(s) of agents.

** Module http://158.37.63.57/doxydoc/classthe__environment.html[THE_ENVIRONMENT]
   Implements the environment and its variation.

** Module http://158.37.63.57/doxydoc/classthe__evolution.html[THE_EVOLUTION]
...
for substituting data in truncated records.
...
IMPORTANT: A Code::Blocks project template for the AHA Model is available
    ...
    https://subversion.uib.no/repos/aha-fortran/trunk/scripts/Project.cbp[Project.cbp].
    This file should be copied to the project folder. the svn command for
    this is: +
    +svn export https://subversion.uib.no/repos/aha-fortran/trunk/scripts/Project.cbp+
...
[source,bash]
--------------------------------------------------------------------------------
svn --username user_name checkout https://subversion.uib.no/repos/aha-fortran/_your_svn_path
--------------------------------------------------------------------------------
...
(https://subversion.uib.no/repos/aha-fortran/trunk/scripts/Project.cbp).
