...
IMPORTANT: Two GNU core utilities are *mandatory* to use the GNU make system:
           https://en.wikipedia.org/wiki/Grep[grep] and
           https://en.wikipedia.org/wiki/Expr[expr]. They can be installed
           from any of the <<GNUCORE_GET, GNU distros for Windows>>.
