...
IMPORTANT: A Code::Blocks project template for the AHA Model is available
    ...
    https://svn.uib.no/aha-fortran/trunk/scripts/Project.bmarks[Project.bmarks],
    https://svn.uib.no/aha-fortran/trunk/scripts/Project.layout[Project.layout].
    All the three files should be copied to the project folder and then
    tweaked as needed.
