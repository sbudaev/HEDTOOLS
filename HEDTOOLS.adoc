...
It is also easy to get an initial <<CODEBLOCKS_USE, Code::Blocks IDE>> *Project
file*. Go to the working copy containing the code, open Terminal and issue:
...
name that is generated into the build options. Go to the menu *Project*, then
*Project options* and switch to the *Build targets* tab:
...
It does not close the terminal upon completion.
