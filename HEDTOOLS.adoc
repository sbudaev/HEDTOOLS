...
error, related to double definition of symbols in libifcoremdd.dll. In such
a case, *libifcoremdd.lib* should be placed into the ignore list as above:
*Properties -> Linker -> Input* then *Ignore Specific Library*.
