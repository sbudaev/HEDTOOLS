...
rather than +.lib+ file extension and +-c+ is used as the compile flag
(not +/c+). The redistributable *zip* file that is produced when building
the library contains a small +Readme.txt+ file.
