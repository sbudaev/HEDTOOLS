...
!   and the target value is the maximum numeric value of the matrix MATRX_A:
...
If the model is built _without_ using the automatic *GNU make* utility and
the supplied +Makefile+, you should take care about the dependencies and
header files yourself. These are the modules that require manual source
