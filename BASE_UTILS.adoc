...
is sometimes quite useful to define subroutines within subroutines (the
keyword +contains+ can be used within other subroutines and functions!)
...
*Use whole-array operations and array slices instead of loops, as well
as built-in parallel instructions (+where+, +forall+ etc.): it is faster*
