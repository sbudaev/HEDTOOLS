...
image:doc/img/img_doc_far.png[height=280,align="left"]
...
defining the desired range (*minimum*, *maximum*) of the random numbers.
...
In absence of any parameters, generates a normally distributed +real+
(kind 4) random number with *zero mean* and *standard deviation = 1.0.*
May also have two real parameters defining the desired *mean* and *variance*.
