...
Subroutine: ARRAY_RANK
~~~~~~~~~~~~~~~~~~~~~~
indexterm:[ARRAY_RANK]

*ARRAY_RANK* Ranks an array (real kind 4 or 8 or integer, the first parameter)
into an index array, using merge-sort.

Example:

[source]
--------------------------------------------------------------------------------
call ARRAY_RANK(array_to_rank, index_array)
--------------------------------------------------------------------------------
