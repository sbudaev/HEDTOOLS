...
SRC = BASE_UTILS.f90 BASE_CSV_IO.f90 BASE_LOGGER.f90 BASE_ERRORS.f90
OBJ = BASE_UTILS.o BASE_CSV_IO.o BASE_LOGGER.o BASE_ERRORS.o
MOD = base_utils.mod  csv_io.mod  logger.mod assert.mod errors.mod exception.mod throwable.mod 
DOC = BASE_UTILS.adoc
LIB = lib_hedutils.a
DIB = lib_hedutils.so
...
distclean: neat
	-rm -f $(OBJ) $(MOD) $(LIB) $(DIB) $(DOCDIR)/BASE_UTILS.$(DOCFMT) $(ZIPFILE) $(AUTOGEN_README_FILE)
