...
#        on Windows).
# Quirk: Windows 10 does not seem to use third-party echo.exe (e.g. from
#        GNUwin32 or Linus services if simple echo is referred under shell.
#        This requires redefining ECHO to refer to a specific exe explicitly.
ifdef ComSpec
...
# Note that shell echo is redefined on Windows
